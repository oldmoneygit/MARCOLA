...
export function ClientCard({
  ...
  // Handler para atualizar telefone do cliente
  const handlePhoneUpdate = useCallback(async (newPhone: string) => {
    if (onUpdateClient) {
      await onUpdateClient(client.id, { contact_phone: newPhone });
    }
  ...
  return (
    ...
    >
      ...
      <SendWhatsAppModal
        ...
        clientPhone={client.contact_phone || undefined}
        onPhoneUpdate={onUpdateClient ? handlePhoneUpdate : undefined}
      />
    </GlassCard>
  );
}
